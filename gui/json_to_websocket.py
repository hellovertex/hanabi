...
from gui import gui_utils as utils
...
def _action_clue(action, agent_pos, num_players):
    ...
    This method is only called from inside get_json_for_pyhanabi_action"""
    action_msg = ''
    ...
    if action['action_type'] == "REVEAL_COLOR":
        ...
        cluevalue = str(utils.pyhanabi_color_to_gui_suit(action['color']))
...
def get_json_for_pyhanabi_action(action, abs_card_nums, agent_pos, num_players, hand_size):
