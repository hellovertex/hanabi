...
import json_to_pyhanabi, gui_utils
...
class GameStateWrapper:
    ...
    def card(suit: int, rank: int):
        ...
        return {'color': gui_utils.gui_suit_to_pyhanabi_color(suit), 'rank': rank}
    ...
    def get_legal_moves(self):
        ...
        if self.information_tokens > 0:
            ...
            for i in range(1, self.num_players):
                ...
                colors = gui_utils.sort_colors_to_pyhanabi_RYGWB(colors)
                for c in colors:
    ...
    def parse_action_to_msg(self, action: Union[dict, int]) -> str:
        ...
        return cmd.get_json_for_pyhanabi_action(
            action=action,
