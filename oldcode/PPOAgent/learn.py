...
import numpy as np
import os
from oldcode.PPOAgent.util import *
from tf_agents_lib.pyhanabi_env_wrapper import *
from oldcode.PPOAgent.Model import Model
from oldcode.PPOAgent.Game import Game
...
def learn(run_name, nupdates, k, ENV_CONFIG, MODEL_CONFIG,  REWARDS_CONFIG, wait_rewards = True,
    ...
    model = Model(nactions, nobs, nplayers, sess = sess,
                     **MODEL_CONFIG)
    game = Game(nplayers, model, load_env, REWARDS_CONFIG, wait_rewards = wait_rewards)
