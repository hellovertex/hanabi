...
from tf_agents_lib import actor_distribution_network_custom, pyhanabi_env_wrapper, critic_network_custom
import rl_env
...
def train_eval(
    ...
    with tf.compat.v2.summary.record_if(
        ...
        eval_tf_env = tf_py_environment.TFPyEnvironment(py_env_eval)
