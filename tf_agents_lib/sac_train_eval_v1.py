...
# custom imports:
from tf_agents_lib import masked_networks, pyhanabi_env_wrapper, critic_network_custom
import rl_env
...
def train_eval(
    ...
    with tf.compat.v2.summary.record_if(lambda: tf.math.equal(global_step % summary_interval, 0)):
        ...
        trajectories, unused_info = next(dataset_iterator)
        """
